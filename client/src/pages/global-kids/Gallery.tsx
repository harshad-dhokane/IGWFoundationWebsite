...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="relative overflow-hidden bg-pink-50 py-16 md:py-24" ref={sectionRef}>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 right-[10%] w-20 h-20 bg-pink-200/40 shape-triangle animate-float"></div>
        <div className="absolute bottom-20 left-[15%] w-16 h-16 bg-pink-300/40 shape-star animate-float-reverse"></div>
        <div className="absolute top-1/2 right-[20%] w-24 h-24 bg-pink-100/40 shape-diamond animate-pulse-gentle"></div>
      </div>
